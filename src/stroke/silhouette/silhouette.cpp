...
void Silhouette::setupSilhouette() {
...
terrain(_terrain)
 {
	...
	std::ifstream input_fstream("/run/media/lot1aus/hdd_2/CG Class/project/Terrain-Sketching/src/stroke/silhouette/point-samples.txt");
	// std::ifstream input_fstream("/Users/vibster/Developer/CSE333-CG/Project/Terrain-Sketching/src/stroke/silhouette/point-samples.txt");
	float x,y,z;
